...
public class WebActionHelperMethods {
	...
	/**
	 * methode Auto suggest : Below is the code to select the Option based on the string passed in the Test. We are List as
	 * option can be more than one. By iterating the list we will select the required option.
	 *
	 * @param elementWeb
	 * @param writeText
	 * @param textToSelect
